  ...
  admin: [
    ...
    { id:"sorozat-szerk", title:"Sorozat szerkesztése", open:false, items:[
      ...
      { q:"Hogyan viszek fel tömegesen sok Számot egyszerre a draftba?",
        a:"<p>A draft-szerkesztő nézet alján a <b>„+ Új szám”</b> mellett ott a <b>„⬇ Sablon”</b> és <b>„⬆ Sablon feltöltése”</b> gomb — ugyanaz a sablon-mechanizmus, mint az Excel-importnál, csak ez a draftba (nem az élő adatba) tölt be tömegesen új Számokat. A draft-szerkesztőben a már meglévő (azonos lapszámú) tételt a feltöltés <b>frissíti</b> a sablon nem üres celláinak értékeire (üres cella nem töröl), az új lapszámokat pedig felveszi; a megerősítő ablak előre megmutatja, hány új / frissülő / változatlan tétel lesz. Publikáláskor a módosítás a szokásos diff → verzió → felkiáltójel folyamaton megy át.</p>" },
