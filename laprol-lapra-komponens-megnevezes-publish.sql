-- ============================================================================
-- LAPRÓL LAPRA — "Megnevezés" mező átvezetése a publish_draft_series()
-- SECURITY DEFINER függvénybe. A komponens-diff eddig csak tipus/
-- azonosito_tipus/azonosito mezőket hasonlított és frissített — most a
-- megnevezes is bekerül (diff + change_log + UPDATE + a vadonatúj
-- komponens INSERT ága). Idempotens (create or replace), a függvény
-- törzse a jelenlegi éles definícióból (13.8/14. pont utáni állapot)
-- lett kiindulva, csak a megnevezes-sorokkal bővítve.
-- ============================================================================
