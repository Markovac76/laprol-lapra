...
**Verzió:** 1.16 · **Állapot:** ÉLES, aktív fejlesztés (a Lapról Lapra modul v1) · **Projekt:** Collector app
...
### 5.1 Sorozat
UUID · kód · **kiadó** · **kategória (témakör)** (v1.16 — listatár-alapú, opcionális; lásd 10.2) · **megnevezés** (teljes név) · **megjelenítendő név** (fülön, max **16** karakter) · **szín** (bővíthető, családokba rendezett paletta, de bármennyi sorozat) · **komponens-készlet** (mely komponensekből áll egy szám ebben a sorozatban — a modul készletéből választva). **[DÖNTVE]**
