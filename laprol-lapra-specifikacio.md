...
**Verzió:** 1.15 · **Állapot:** ÉLES, aktív fejlesztés (a Lapról Lapra modul v1) · **Projekt:** Collector app
...
2. **12 fölötti sorozatszám kezelése — 8–15 sorozatra tervezve** **[DÖNTVE, megvalósítva]**
   - **Színek:** bővített, **színcsaládokba csoportosított** paletta (6 család). A színválasztó vizuálisan csoportosítva mutatja a családokat, hogy logikailag összetartozó sorozatok hasonló árnyalatot kaphassanak. **Nincs mögötte tárolt kategória-adat** — tisztán vizuális segítség/konvenció (staff manuálisan választja a megfelelő családot), tudatosan nem előlegzi meg a platform jövőbeli címke-/fogalomtárát.
   - **Kategória → színcsalád tematizálás [DÖNTVE, megvalósítva — v1.15]:** a Kék/Magenta/Zöld családok konkrét témakörökhöz lettek rendelve — **Modellek → Kék** (II VH Repülők, Forma 1, Volkswagen, Fast & Furious), **Mese → Magenta** (Disney könyvek, Disney Hangoskönyvek, Mancs Őrjárat), **Lego → Zöld** (Lego Star Wars, Lego Marvel — a család 8 árnyalatra bővítve, mert ez a legdinamikusabban bővülő kategória; 6 árnyalat egyelőre tartalék, a tervezett Spider-Man/Batman/Jurassic Park/Ninjago sorozatoknak). Minden család a MEGLÉVŐ hue/szaturáció-értékét tartja meg, csak a világosság-lépcső bővült szisztematikusan (azonos hue/szat, egyenletes lightness-lépések 25%-70% közt) — a Kék 4→5, a Magenta 4→4 (a régi, kilógó hue-jú 4. tag cserélve), a Zöld 4→8 árnyalatra. A 9 jelenleg létező érintett sorozat át lett színezve, létrehozási sorrend szerint (sötéttől világosig). SQL: `laprol-lapra-sorozat-szin-tematizalas.sql`.
